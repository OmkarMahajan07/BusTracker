...
import vvceLogo from "../assets/vvce.jpeg"; // place your VVCE image here

export default function Home() {
  return (
    <div className="min-h-[calc(100vh-64px)] relative overflow-hidden bg-gradient-to-b from-[#0b1b3a] via-[#102a5c] to-[#0a1225] text-white">
      {/* Decorative stars */}
        ...
        >
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              ...
              <p className="text-blue-200">Vidyavardhaka College of Engineering, Mysuru</p>
            </div>
          </div>
          ...
          <div className="flex flex-wrap gap-4">
            <Link to="/student-login">
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                className="flex items-center gap-2 px-6 py-3 rounded-xl bg-gradient-to-r from-blue-500 to-indigo-600 shadow-lg shadow-blue-500/30 font-semibold"
              >
            ...
            <Link to="/driver">
              <motion.button
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.98 }}
                className="flex items-center gap-2 px-6 py-3 rounded-xl bg-gradient-to-r from-emerald-500 to-green-600 shadow-lg shadow-green-500/30 font-semibold"
              >
            ...
            <Link to="/map">
              <motion.button
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.98 }}
                className="flex items-center gap-2 px-6 py-3 rounded-xl bg-white/10 backdrop-blur border border-white/20 hover:bg-white/20"
              >
