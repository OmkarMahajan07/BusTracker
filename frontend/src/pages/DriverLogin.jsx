    ...
    <div className="min-h-screen bg-gradient-to-b from-[#0b1b3a] via-[#102a5c] to-[#0a1225] text-white flex items-center justify-center px-4">
      ...
      >
        ...
        <div className="space-y-4">
          <input
            type="text"
            className="w-full px-4 py-3 rounded-xl bg-white/10 border border-white/20 text-white placeholder-gray-300 outline-none focus:ring-2 focus:ring-emerald-400"
          ...
          <motion.button
            ...
            disabled={loading}
            onClick={login}
            className="w-full py-3 rounded-xl bg-gradient-to-r from-emerald-500 to-green-600 shadow-lg shadow-green-500/30 font-semibold disabled:opacity-60 text-white"
          >
