...
const BUS_OPTIONS = [
  {
    ...
    number: "9912",
    color: "purple",
    startLocation: "Sub Urban",
    stopLocation: "VVCE Mysuru",
    travelTime: "7:15 AM – 7:45 AM  |  3:30 PM – 4:00 PM",
    routeName: "Sub Urban → VVCE Mysuru",
    driverName: "Nagesh",
    plateNumber: "KA 09 AB 9912",
    stops: [
      "Sub Urban, Mysuru",
      "Hardinge Circle, Mysuru",
      "Railway Station, Mysuru",
      "Vontikoppal, Mysuru",
      "VVCE Mysuru",
    ],
  },
  {
    ...
    startLocation: "Sub Urban",
    stopLocation: "VVCE Mysuru",
    travelTime: "7:25 AM – 7:55 AM  |  3:40 PM – 4:10 PM",
    routeName: "Sub Urban → VVCE Mysuru",
    stops: [
      "Sub Urban, Mysuru",
      "Hardinge Circle, Mysuru",
  ...
  },
  {
    ...
    startLocation: "Sub Urban",
    stopLocation: "VVCE Mysuru",
    travelTime: "7:35 AM – 8:05 AM  |  3:50 PM – 4:20 PM",
    routeName: "Sub Urban → VVCE Mysuru",
    stops: [
      "Sub Urban, Mysuru",
      "Hardinge Circle, Mysuru",
